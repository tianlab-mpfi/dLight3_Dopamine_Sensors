...
filePath = 'E:\data_summaries\dLight\looming_early_vs_late_trials\separate_sensors\dLight3_only';
filePath_dLight3a6 = 'E:\data_summaries\dLight\looming_early_vs_late_trials\separate_sensors\dLight3a6';
filePath_dLight3a8 = 'E:\data_summaries\dLight\looming_early_vs_late_trials\separate_sensors\dLight3a8';
file_dLight3a6 = 'peak*';
file_dLight3a8 = 'peak*';
...
[h,p_response_incr_ttest_all] = ttest(early_peak_all,late_peak_all,'tail','left')
% Test hypothesis that the the distribution mean of early trials is larger
% than the mean of late trials (i.e. the response INcreases over trials, since this is a negative response)
...
% Save data
save(fullfile(filePath, 'early_vs_late_stats.mat'),'p_response_incr_signrank_dLight3a6',...
    'p_response_incr_ttest_dLight3a6','early_peak_dLight3a6_avg',...
    'late_peak_dLight3a6_avg','early_peak_dLight3a6_median','late_peak_dLight3a6_median',...
    'p_response_incr_signrank_dLight3a8','p_response_incr_ttest_dLight3a8','early_peak_dLight3a8_avg',...
    'late_peak_dLight3a8_avg','early_peak_dLight3a8_median','late_peak_dLight3a8_median','early_peak_all_avg',...
    'late_peak_all_avg','p_response_incr_ttest_all');
...
figname = 'early vs late comparison scatterplot dLight3 only';
